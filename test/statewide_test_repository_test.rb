...
class StatewideTestRepositoryTest < Minitest::Test
 ...
 def test_loads_data
      ...
      assert_equal result1, statewiderepo_class.statewide_tests["ACADEMY 20"].data[:asian]
      assert_equal result2, statewiderepo_class.statewide_tests["ACADEMY 20"].data[3]
 end
